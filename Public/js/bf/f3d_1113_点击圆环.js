...
//注册交互点击
function initClick(drawRect, tdtMap, scene, render, camera, demMesh, bboxGeo, lineDashMaterial,
    ringWaveMaterial,minEle,maxEle) {
