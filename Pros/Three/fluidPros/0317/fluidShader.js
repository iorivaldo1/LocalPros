...
function createWaterRenderMaterial() {
    return new THREE.ShaderMaterial({
        uniforms: {
            ...
            uWaterColor: { value: new THREE.Color(0x7d9d50) },  // 污染水体：浅色区呈现浑浊的黄褐色/橄榄色（提高亮度）
            uDeepColor: { value: new THREE.Color(0x2a3420) },   // 污染水体：深色区呈现深绿黑色（提高亮度）
        ...
        vertexShader: `
            ...
            void main() {
                ...
                // 水面位置 = 地形高度 + 水深
                // 两者都是归一化高度 [0, 1]，不需要额外的缩放
                vec3 pos = position;
                pos.z = terrainH + waterH;
